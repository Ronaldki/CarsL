        ...
        <div class="panel panel-default">
          <div class="panel-body">  
                          ...
                          ?>
                                    <tr>
                                      ...
                                      <input type="NUMBER" data-id="<?php echo $result->PRODUCTID;  ?>" class="qty" name="QTY<?php echo $result->PRODUCTID;  ?>" id="QTY<?php echo $result->PRODUCTID; ?>"  value="<?php echo $_SESSION['fixnmix_cart'][$i]['qty'] ?>"/>
                                        ...
                                        <td>
                                        Price &nbsp;<output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price']; ?></output>
                                        </td>
                                      <!-- hidden textbox -->
           ...
           <tfoot  >
                ...
                <a href="index.php?view=addorder" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Add Another Car</strong></a>
