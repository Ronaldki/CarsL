         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td>Price<?php echo number_format($result->PRICE,2) ?></td>
                        ...
                        <td>Price<output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
                  ...
                  <tfoot >
                     <strong><h1 align="right">Total Price : <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
                        ...
                        <?php    
                             ...
                             echo '<a href="index.php?page=2" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Add Another Car</strong></a>';
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <!-- <input type="checkbox" name="condition" value="checkbox" /> -->
                      <small>Agree the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of Lira car sell</small>
                      
                      </div>
                    </div>
                  </div>
 
                  <div class="modal-footer"><p align="left">&copy; Lira Car sellers</p>
                    <button class="btn btn-default" data-dismiss="modal" type=
                    "button">Close</button> 
