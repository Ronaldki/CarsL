          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Bamakanika</span>Car sellers</h1>
                  <h2>We sell and buy used cars</h2>
                  <p>It's Only here where you can find Good cars of your priority </p>
      ...
      <div class="row">
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h2>Price<?php  echo $result->PRODISPRICE; ?></h2>
       ...
       <?php  } ?>
          ...
          <div class="recommended_items"><!--recommended_items-->
            <h2 class="title text-center">Cars on sale</h2>
