 ...
 <h4><strong>Order Information</strong></h4>
        ...
        <?php
          ...
          $query = "SELECT * 
            ...
            foreach ($cur as $result) {
              ...
              echo '<td> Price '. number_format($result->PROPRICE,2).' </td>';
              echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
              ?>
               <td> Price <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td> 
              <?php
    ...
    <div class="row">
        ...
        <div class="col-md-6 pull-right">
          <p align="right">Total Price : Price <?php echo number_format($tot,2);?></p>
          <p align="right">Delivery Fee : Price <?php echo number_format($price,2); ?></p>
          <p align="right">Overall Price : Price <?php echo number_format($cur->PAYMENT,2); ?></p>
        </div>
      </div>
